...
function buildQueue(tenses: TenseId[], count: number, filters: VerbFilters): Question[] {
...
export default function ConjugationScreen() {
  ...
  const startSession = useCallback((tenses: TenseId[], count: CountOption, filters: VerbFilters) => {
    const q = buildQueue(tenses, count, filters);
